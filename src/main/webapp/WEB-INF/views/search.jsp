...
<div class="container">
	...
	<div class="left_100 right-sec-content" style="overflow: visible;">
		...
		<form  method ="post" action="${contextPath}/searchsubreport" modelAttribute="searchvo" commandName="searchvo">
    		...
    		<table style=" padding-left: 370px ;align: center;">
							  <tr>
                                 	...
                                 	<td class="trspace"> 
						            	<form:select path="searchvo.reportName"   class="form-control float_left" >
						            		<form:option value="" label="--- Select Report ---"/>
										    <form:options path="reportName" id="reportName" items="${searchvo.reportNames}" itemLabel="discription" itemValue="reportName"  style="height:25px;font-size: 15px; "/>
										</form:select>
